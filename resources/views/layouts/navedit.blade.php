    ...
    <div class="container">
        ...
        <div class="topnav d-none d-lg-flex align-items-center">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Route::is('memorial.edit') ? 'active' : '' }}" href="{{ route('memorial.edit', ['id' => $memorial->id]) }}">
                        Adatok szerkesztése
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link {{ Route::is('memorial.images.edit') ? 'active' : '' }}" href="{{ route('memorial.images.edit', ['id' => $memorial->id]) }}">
                        Fényképek
                    </a>
                </li>
