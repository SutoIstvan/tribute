        ...
        <div class="container">
            ...
            <div class="topnav d-none d-lg-flex align-items-center">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('memorial.codelist') ? 'active' : '' }}" href="{{ route('memorial.codelist') }}">Életrajz</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('price') ? 'active' : '' }}" href="{{ route('price') }}">Fényképek</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('price') ? 'active' : '' }}" href="{{ route('price') }}">Videó</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('contact') ? 'active' : '' }}" href="{{ route('contact') }}">Hozzászólások</a>
                    </li>
                    <li class="nav-item">
                        @auth
