        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="item md-mb50">
                        <div class="head text-center pb-40 bord-thin-bottom-light">
                            <h6 class="text-u fz-20 mb-40">Egy csomag</h6>
                            <h2 class="fz-70 mb-5">20.000 ft</h2>
                            <span class="sub-color">Mindörökké</span>
                        </div>
                        <div class="list mt-40">
                            <ul class="rest">
                                <li>30 fénykép egy emlékoldalhoz</li>
                                <li>Két oldalstílus közül választhat</li>
                                <li>Megjegyzések korlátozás nélkül</li>
                            </ul>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="item md-mb50">
                        <div class="head text-center pb-40 bord-thin-bottom-light">
                            <h6 class="text-u fz-20 mb-40">Hármas csomag</h6>
                            <h2 class="fz-70 mb-5">18.000 ft</h2>
                            <span class="sub-color">Mindörökké</span>
                        </div>
                        <div class="list mt-40">
                            <ul class="rest">
                ...
                <div class="col-lg-4">
                    <div class="item md-mb50">
                        <div class="head text-center pb-40 bord-thin-bottom-light">
                            <h6 class="text-u fz-20 mb-40">Ötös csomag</h6>
                            <h2 class="fz-70 mb-5">15.000 ft</h2>
                            <span class="sub-color">Mindörökké</span>
                        </div>
                        <div class="list mt-40">
                            <ul class="rest">
